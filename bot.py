...
**قناة المطور   : @uwrwe**
#مالك_البوت ➪ @SJee_d
#مطور_ملف_البوت ➪ @K_eDe

وصف البوت ✉
هو بوت تم تنصيبه علا منصه gitHub وتم رفعه علا هيروكو دون سيرفرات 
ومن خلال البوت سيمكنك التحكم في حساب صديقك عبر كود [ **تيرميكس ** - **بايروجرام **]

قائمه الاوامر هي ❤️ : 

A: [ ** عرض جميع الكروبات ولقنوات الي بلحساب  **]

B: [** اضهار معلومات الحساب من ناحية ➪ ** رقم هاتف الحساب** - ** اليوزر ** - ** البايو **]

C: [** لازاله جميع اعضاء المجمودين في قناه او كروب معين **]
...
K: [** تنزيل جميع الادمنيه الموجودين في قناة او مجموعه **]

L: [** رفع حسابك مشرف في قناه او مجموعه حساب الضحيه  **]

M: [** تغيير رقم الهاتف باستعمال كود تيرمكس **]

** مميزات اكثر لاحقاً  عندك فكرة حلوة دزها هنا بدون مقدمات ❤️: @K_eDe **
'''
mm = '''
**
مرحباً، 
  ...
  async with bot.conversation(event.chat_id) as x:
    ...
    if res.text == "A":
      ...
      try:
        ...
        await event.respond("**اذا واجهتك اي مشكله أرسلها هنا : @SJee_d**" + str(e))
